...
# Download hydrophone binary (latest version)
echo "Downloading hydrophone..."
curl -sL https://github.com/kubernetes-sigs/hydrophone/releases/latest/download/hydrophone_linux_amd64.tar.gz | tar -xz -C /usr/local/bin
